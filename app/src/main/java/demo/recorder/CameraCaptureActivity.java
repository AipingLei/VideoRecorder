...
import demo.recorder.gles.SimplePlane;
...
public class CameraCaptureActivity extends Activity
    ...
    static final int FILTER_BITMAP = 6;
...
class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    private SimplePlane mImagePlane;
    ...
    public void notifyPausing() {
        ...
        if (mImagePlane != null) {
            mImagePlane.release(false);     // assume the GLSurfaceView EGL context is about
            mImagePlane = null;             //  to be destroyed
        }
        mIncomingWidth = mIncomingHeight = -1;
    }
    ...
    public void updateFilter() {
        ...
        switch (mNewFilter) {
            ...
            case CameraCaptureActivity.FILTER_EMBOSS:
                ...
                colorAdj = 0.5f;
                break;
            case CameraCaptureActivity.FILTER_BITMAP:
                programType = Texture2dProgram.ProgramType.TEXTURE_EXT_BITMAP;
                break;
            default:
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mImagePlane = new SimplePlane(
                new Texture2dProgram(Texture2dProgram.ProgramType.TEXTURE_EXT),mBitmap);
        mBitmap = BitmapHelper.createBitmap(640, 480);
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        if (mIncomingSizeUpdated) {
            ...
            mImagePlane.getProgram().setTexSize(mIncomingWidth, mIncomingHeight);
            mIncomingSizeUpdated = false;
        }
        ...
        mImagePlane.drawFrame(mSTMatrix);
