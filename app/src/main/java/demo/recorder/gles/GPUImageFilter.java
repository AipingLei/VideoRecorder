...
//        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, 0);
    ...
    @Override
    public jp.co.cyberagent.android.gpuimage.filter.GPUImageFilter clone()
    {
...
//    	return null;
    	...
    	jp.co.cyberagent.android.gpuimage.filter.GPUImageFilter result = null;
		try {
			Constructor<?> construstor = this.getClass().getConstructor();
			
			result = (jp.co.cyberagent.android.gpuimage.filter.GPUImageFilter) construstor.newInstance();
			result.init();
