...
public class Texture2dProgram {
    ...
    public enum ProgramType {
        TEXTURE_2D, TEXTURE_EXT, TEXTURE_EXT_BW, TEXTURE_EXT_FILT,TEXTURE_EXT_BITMAP
    }
    ...
    // Simple two texture vertex shader
    private static final String VERTEX_SHADER_TWO = "attribute vec4 position;\n" +
   ...
   // Simple fragment shader for use with "normal" 2D textures with two textures
   private static final String FRAGMENT_SHADER_2D_TWO = "varying highp vec2 textureCoordinate;\n" +
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        switch (programType) {
            ...
            case TEXTURE_EXT_FILT:
                ...
                break;
            case TEXTURE_EXT_BITMAP:
                mTextureTarget = GLES20.GL_TEXTURE_2D;
                mProgramHandle = GlUtil.createProgram(VERTEX_SHADER_TWO, FRAGMENT_SHADER_2D_TWO);
                break;
            default:
     ...
     * @return Handle to texture.
     */
    public static int createBitampTexture(Bitmap bitmap) {
        // Generate one texture pointer...
        // ...and bind it to our array
        //使用 OpenGL 库创建一个材质(Texture)，首先是获取一個 Texture Id。
        int[] textureHandles = new int[1];
        int textureHandle;
        GLES20.glGenTextures(1, textureHandles, 0);
        textureHandle = textureHandles[0];
        ...
        GlUtil.checkGlError("createBitampTexture");
  ...
  /*  public void draw(float[] mvpMatrix, FloatBuffer vertexBuffer, int firstVertex,
       ...
       // GLES20.glVertexPointer(3, GL10.GL_FLOAT, 0, mVerticesBuffer);
        // Set flat color
        //GLES20.glColor4f(mRGBA[0], mRGBA[1], mRGBA[2], mRGBA[3]);
        // Smooth color
