...
public class MagicNashvilleFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicNashvilleFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.nashville));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGLUtils.loadTextureFromR(mContext, R.drawable.nashvillemap);
		    }
	    });
	}
}
