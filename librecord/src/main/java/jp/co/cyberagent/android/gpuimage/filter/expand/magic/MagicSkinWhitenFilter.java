...
/**
 * 美白,与MagicBilateralFilter滤镜同时使用,效果更好,不过性能消耗较大
 * @author sulei
 */
public class MagicSkinWhitenFilter extends MagicBeautyFilter {
	@Override
	public String toString() {
		return "SkinWhiten:美白";
	}
    ...
    public MagicSkinWhitenFilter(Context context) {
    	super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.skinwhiten));
    }
