...
public class GPUImageToneCurveFilter extends GPUImageFilterContext {
	@Override
    ...
    public GPUImageToneCurveFilter(Context context) {
        super(context, TONE_CURVE_FRAGMENT_SHADER);
