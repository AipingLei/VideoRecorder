...
public class OpenGLUtils {
    ...
    public static int loadTextureFromAssets(final Context context, final String name){
	...
	public static int loadTextureFromR(final Context context, final int rId){
		final int[] textureHandle = new int[1];
		...
		if (textureHandle[0] != 0){
			...
			// Read in the resource
			final Bitmap bitmap = getImageFramR(context, rId);
	...
	private static Bitmap getImageFramR(Context context, int rId)
	{
