...
public class MagicPixarFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicPixarFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.pixar));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGLUtils.loadTextureFromR(mContext, R.drawable.pixar_curves);
		    }
	    });
	}
}