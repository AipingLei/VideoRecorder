 ...
 * @author sulei
 */
public class MagicTenderFilter extends GPUImageFilterContext{
	...
	public MagicTenderFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.tender));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.bluevintage_mask1);
		    }
	    });
	}
}
