 ...
 *
 */
public class MagicInkwellFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicInkwellFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.inkwell));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGLUtils.loadTextureFromR(mContext, R.drawable.inkwellmap);
		    }
	    });
	}
}
