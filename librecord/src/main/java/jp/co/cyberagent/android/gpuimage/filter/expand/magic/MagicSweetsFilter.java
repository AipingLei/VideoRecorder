 ...
 * @author sulei
 */
public class MagicSweetsFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicSweetsFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.sweets));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.rise_mask2);
		    }
	    });
	}
}
