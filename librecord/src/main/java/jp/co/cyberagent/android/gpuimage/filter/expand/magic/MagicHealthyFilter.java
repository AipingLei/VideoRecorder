 ...
 *
 */
public class MagicHealthyFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicHealthyFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.healthy));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.healthy_mask_1);
		    }
	    });
	}
