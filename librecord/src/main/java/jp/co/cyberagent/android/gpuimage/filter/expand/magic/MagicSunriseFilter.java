 ...
 * @author sulei
 */
public class MagicSunriseFilter extends GPUImageFilterContext{
	...
	public MagicSunriseFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.sunrise));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE4);
		        mMaskGrey1TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.amaro_mask1);
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
		        mMaskGrey2TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.amaro_mask2);
		        GLES20.glActiveTexture(GLES20.GL_TEXTURE6);
		        mMaskGrey3TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.toy_mask1);
		    }
	    });
	}
