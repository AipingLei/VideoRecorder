 ...
 * @author sulei
 */
public class MagicWarmFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicWarmFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.warm));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.warm_layer1);
		        mMaskGrey2TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.bluevintage_mask1);
		    }
	    });
	}
}
