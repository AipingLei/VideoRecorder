...
public class MagicHudsonFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicHudsonFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.hudson));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGLUtils.loadTextureFromR(mContext, R.drawable.hudsonbackground);
				inputTextureHandles[1] = OpenGLUtils.loadTextureFromR(mContext, R.drawable.overlaymap);
				inputTextureHandles[2] = OpenGLUtils.loadTextureFromR(mContext, R.drawable.hudsonmap);
		    }
	    });
	}
}
