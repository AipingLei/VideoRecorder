 ...
 * @author sulei
 */
public class MagicSunsetFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicSunsetFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.sunset));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.rise_mask1);
		        mMaskGrey2TextureId = OpenGLUtils.loadTextureFromR(mContext, R.drawable.rise_mask2);
		    }
	    });
	}
