...
public class MagicAmaroFilter extends GPUImageFilterContext{
	@Override
	...
	public MagicAmaroFilter(Context context){
		super(context,OpenGLUtils.readShaderFromRawResource(context, R.raw.amaro));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	...
		    	inputTextureHandles[0] = OpenGLUtils.loadTextureFromR(mContext,  R.drawable.brannan_blowout);
				inputTextureHandles[1] = OpenGLUtils.loadTextureFromR(mContext, R.drawable.overlaymap);
				inputTextureHandles[2] = OpenGLUtils.loadTextureFromR(mContext, R.drawable.amaromap);
		    }
	    });
	}
