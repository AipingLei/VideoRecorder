...
public abstract class MagicLookupFilter extends GPUImageFilterContext {
...
//    protected String table;
    ...
    public MagicLookupFilter(Context context,int tableRId) {
...
//        this.table = table;
    ...
    public void onInitialized(){
    	...
    	runOnDraw(new Runnable(){
    		public void run(){
//    			mLookupSourceTexture = OpenGLUtils.loadTextureFromAssets(mContext, table);
    			mLookupSourceTexture = OpenGLUtils.loadTextureFromR(mContext, tableRId);
    		}
    	});
    }
